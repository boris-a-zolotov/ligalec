...
\begin{frame} \frametitle{Покажем, как раскладывается сигнал в сумму волн}
    \incg{python-fourier/signal} \bigskip

    Будем добавлять слагаемые в порядке возрастания частоты.
\end{frame}
